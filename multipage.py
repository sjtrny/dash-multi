...
def copy_func(func):
    ...
    copied_func = types.FunctionType(func.__code__, func.__globals__, name=func.__name__,
...
class MultiPageApp(dash.Dash):
    ...
    def _multilayout(self, pathname):
        ...
        elif pathname is '/' or pathname is None:
    ...
    def parse_routes(handler, cur_path = None):
        ...
        if isinstance(handler, list):
            ...
            for sub_route in route_list:
                ...
                sub_routing_dict, sub_layout_list, sub_callback_list = MultiPageApp.parse_routes(sub_route.handler, f"{cur_path}{sub_route.path}")
    ...
    def set_routes(self, handler):
        ...
        self.callback(Output('page-content', 'children'), [Input('url', 'pathname')])(self._multilayout)
